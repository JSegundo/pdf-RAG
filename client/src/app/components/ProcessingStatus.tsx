...
// const STAGES: ProcessingStage[] = [
//   { stage: 'started', label: 'Processing started' },
//   { stage: 'extracting', label: 'Extracting text' },
//   { stage: 'chunking', label: 'Breaking down content' },
//   { stage: 'embedding', label: 'Generating embeddings' },
//   { stage: 'storing', label: 'Storing data' },
// ];
...
//   // Calculate current progress based on stages
...
//           <div 
//             key={stage.stage} 
//             className={`stage ${currentStage === stage.stage ? 'current' : ''} ${
//               STAGES.findIndex(s => s.stage === currentStage) >= STAGES.findIndex(s => s.stage === stage.stage) ? 'completed' : ''
//             }`}
//           >
